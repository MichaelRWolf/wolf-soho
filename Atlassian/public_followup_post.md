...
• Day 0 (Sep 30): logged in and used Confluence extensively (later confirmed by Atlassian).

• Day 44 (Nov 13): The Confluence subscription was expired for “inactivity” (date inferred retroactively from Atlassian messages)
• Day 58 (Nov 27): Site data was permanently deleted after a 14-day soft-deletion window (date inferred ...)
